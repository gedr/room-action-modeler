...
public class AnimatingAddNode extends JFrame {
	// =================================================================================================================
	// Constants
	// =================================================================================================================
...
//				vv.getRenderContext().getMultiLayerTransformer().setToIdentity();
    ...
    public static void main(String[] args) {
    	AnimatingAddNode aand = new AnimatingAddNode();
    	aand.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    	aand.start();
    	aand.pack();
    	aand.setVisible(true);
    }
